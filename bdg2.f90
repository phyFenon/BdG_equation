...
Program Bdg_second_square
      ...
      Integer :: ngrid =10
      Integer :: N
      Double Precision :: miu = -1.0d0, v = 3.0d0, eps = 10.0e-7, T = 10.0e-22
...
!
     ...
     Open (10, File='mo_u=-1.0_v=4.0.txt')
	! Open (30, File='fujiao_u=-1.0_v=4.0.txt')
	 open (40, File='fushu_u=-1.0_v=4.0.txt')
   ...
   !write(30,*),acos(real(delta0(i,u))/abs(delta0(i,u)))/pi-acos(real(delta0(i,r))/abs(delta0(i,r)))/pi,&
   !&acos(real(delta0(i,d))/abs(delta0(i,d)))/pi-acos(real(delta0(i,r))/abs(delta0(i,r)))/pi,&
   !&acos(real(delta0(i,l))/abs(delta0(i,l)))/pi-acos(real(delta0(i,r))/abs(delta0(i,r)))/pi,&
   ! &acos(real(delta0(i,r))/abs(delta0(i,r)))/pi-acos(real(delta0(i,r))/abs(delta0(i,r)))/pi
